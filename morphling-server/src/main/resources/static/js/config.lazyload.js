...
angular.module('app')
    ...
    .constant('JQ_CONFIG', {
            ...
            daterangepicker: ['vendor/jquery/daterangepicker/moment.js',
                'vendor/jquery/daterangepicker/daterangepicker.js',
    ...
    .config(['$ocLazyLoadProvider', function ($ocLazyLoadProvider) {
        ...
        $ocLazyLoadProvider.config({
            ...
            modules: [
                {
                    name:'chart',
                    files: ['//cdn.bootcss.com/Chart.js/2.1.0/Chart.min.js']
                },
                {
                    name: 'ngGrid',
                    files: [
                ...
                },
                {
                    name: 'ngFileUpload',
                    files: [
                        'vendor/modules/ng-file-upload/ng-file-upload.min.js',
                        'vendor/modules/ng-file-upload/ng-file-upload-shim.min.js'
                    ]
                },
                {
                    name: 'ui.calendar',
